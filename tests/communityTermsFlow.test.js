...
test('desktop verification uses action buttons before showing a completed state', () => {
  ...
  assert.match(creatorApplicationSource, /title: 'Submit with an email address'/)
  assert.match(creatorApplicationSource, /inlineCompletion: true/)
  assert.match(creatorApplicationSource, /hideAction: true/)
  assert.match(verificationStepSource, /verification-email-input/)

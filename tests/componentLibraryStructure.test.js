...
test('separates exploratory work into a prototypes section', () => {
  ...
  assert.match(componentLibraryPrototypesSource, /const prototypeTabs = \[/)
  assert.match(componentLibraryPrototypesSource, /role="tablist"/)
  assert.match(componentLibraryPrototypesSource, /role="tabpanel"/)
  ...
  assert.doesNotMatch(componentLibraryPrototypesSource, /title: 'Data Gathering Wonder Sequence'/)
  assert.doesNotMatch(componentLibraryPrototypesSource, /title: 'Submission Success: Cursor Burst Review'/)
  assert.doesNotMatch(componentLibraryPrototypesSource, /title: 'Submission Success: Cursor Burst Interaction'/)
  assert.doesNotMatch(componentLibraryPrototypesSource, /title: 'Verification Expansion'/)
})
